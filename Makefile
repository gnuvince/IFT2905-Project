...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Thu Apr 14 18:22:52 2011
# Project:  projet.pro
# Template: app
...
SOURCES       = geoposition.cpp \
		...
		mainmenupage.cpp \
		findstationpage.cpp \
		selectpositionpage.cpp moc_geopositiondelegate.cpp \
		moc_mainwindow.cpp \
		moc_note.cpp \
		moc_notemodel.cpp \
		moc_reservation.cpp \
...
tar:
	tar -zcf projet.tar.gz geoposition.cpp geopositiondelegate.cpp main.cpp mainwindow.cpp manote.cpp note.cpp notemodel.cpp reservation.cpp reservationmodel.cpp simulateur.cpp station.cpp stationmodel.cpp usager.cpp usagermodel.cpp vehicule.cpp vehiculemodel.cpp reservationproxymodel.cpp robot.cpp cartescene.cpp carteelements.cpp cartewidget.cpp userinterface.cpp page.cpp mainmenupage.cpp findstationpage.cpp selectpositionpage.cpp geoposition.h geopositiondelegate.h mainwindow.h manote.h note.h notemodel.h reservation.h reservationmodel.h simulateur.h station.h stationmodel.h usager.h usagermodel.h vehicule.h vehiculemodel.h robot.h reservationproxymodel.h cartescene.h carteelements.h cartewidget.h userinterface.h page.h mainmenupage.h findstationpage.h selectpositionpage.h mainwindow.ui cartewidget.ui userinterface.ui icones.qrc data/xml/map_montreal.osm data/xml/*.xml data/images/icons/*.png data/images/stations/*.jpg data/images/stations/*.gif data/images/vehicules/*.png projet.pro
...
moc_mainmenupage.cpp: page.h \
		mainmenupage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) mainmenupage.h -o moc_mainmenupage.cpp

moc_findstationpage.cpp: page.h \
		findstationpage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) findstationpage.h -o moc_findstationpage.cpp

moc_selectpositionpage.cpp: page.h \
		selectpositionpage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) selectpositionpage.h -o moc_selectpositionpage.cpp
...
findstationpage.o: findstationpage.cpp page.h \
		findstationpage.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o findstationpage.o findstationpage.cpp

selectpositionpage.o: selectpositionpage.cpp page.h \
		selectpositionpage.h \
		cartewidget.h \
		geoposition.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o selectpositionpage.o selectpositionpage.cpp
