...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Thu Apr 14 17:01:39 2011
# Project:  projet.pro
# Template: app
...
SOURCES       = geoposition.cpp \
		...
		page.cpp \
		mainmenupage.cpp \
		findstationpage.cpp moc_geopositiondelegate.cpp \
		moc_mainwindow.cpp \
		moc_note.cpp \
		moc_notemodel.cpp \
		moc_reservation.cpp \
...
tar:
	tar -zcf projet.tar.gz geoposition.cpp geopositiondelegate.cpp main.cpp mainwindow.cpp manote.cpp note.cpp notemodel.cpp reservation.cpp reservationmodel.cpp simulateur.cpp station.cpp stationmodel.cpp usager.cpp usagermodel.cpp vehicule.cpp vehiculemodel.cpp reservationproxymodel.cpp robot.cpp cartescene.cpp carteelements.cpp cartewidget.cpp userinterface.cpp page.cpp mainmenupage.cpp findstationpage.cpp geoposition.h geopositiondelegate.h mainwindow.h manote.h note.h notemodel.h reservation.h reservationmodel.h simulateur.h station.h stationmodel.h usager.h usagermodel.h vehicule.h vehiculemodel.h robot.h reservationproxymodel.h cartescene.h carteelements.h cartewidget.h userinterface.h page.h mainmenupage.h findstationpage.h mainwindow.ui cartewidget.ui userinterface.ui icones.qrc data/xml/map_montreal.osm data/xml/*.xml data/images/icons/*.png data/images/stations/*.jpg data/images/stations/*.gif data/images/vehicules/*.png projet.pro
...
moc_findstationpage.cpp: findstationpage.h
...
findstationpage.o: findstationpage.cpp findstationpage.h
