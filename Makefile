...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Thu Apr 14 11:33:50 2011
# Project:  projet.pro
# Template: app
...
SOURCES       = geoposition.cpp \
		...
		cartescene.cpp \
		carteelements.cpp \
		cartewidget.cpp moc_geopositiondelegate.cpp \
		moc_mainwindow.cpp \
		moc_note.cpp \
		moc_notemodel.cpp \
		moc_reservation.cpp \
...
$(TARGET): ui_mainwindow.h ui_cartewidget.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/projet1.0.0/ && $(COPY_FILE) --parents geoposition.h geopositiondelegate.h mainwindow.h manote.h note.h notemodel.h reservation.h reservationmodel.h simulateur.h station.h stationmodel.h usager.h usagermodel.h vehicule.h vehiculemodel.h robot.h reservationproxymodel.h cartescene.h carteelements.h cartewidget.h .tmp/projet1.0.0/ && $(COPY_FILE) --parents icones.qrc .tmp/projet1.0.0/ && $(COPY_FILE) --parents geoposition.cpp geopositiondelegate.cpp main.cpp mainwindow.cpp manote.cpp note.cpp notemodel.cpp reservation.cpp reservationmodel.cpp simulateur.cpp station.cpp stationmodel.cpp usager.cpp usagermodel.cpp vehicule.cpp vehiculemodel.cpp reservationproxymodel.cpp robot.cpp cartescene.cpp carteelements.cpp cartewidget.cpp .tmp/projet1.0.0/ && $(COPY_FILE) --parents mainwindow.ui cartewidget.ui .tmp/projet1.0.0/ && (cd `dirname .tmp/projet1.0.0` && $(TAR) projet1.0.0.tar projet1.0.0 && $(COMPRESS) projet1.0.0.tar) && $(MOVE) `dirname .tmp/projet1.0.0`/projet1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/projet1.0.0
...
tar:
	tar -zcf projet.tar.gz geoposition.cpp geopositiondelegate.cpp main.cpp mainwindow.cpp manote.cpp note.cpp notemodel.cpp reservation.cpp reservationmodel.cpp simulateur.cpp station.cpp stationmodel.cpp usager.cpp usagermodel.cpp vehicule.cpp vehiculemodel.cpp reservationproxymodel.cpp robot.cpp cartescene.cpp carteelements.cpp cartewidget.cpp geoposition.h geopositiondelegate.h mainwindow.h manote.h note.h notemodel.h reservation.h reservationmodel.h simulateur.h station.h stationmodel.h usager.h usagermodel.h vehicule.h vehiculemodel.h robot.h reservationproxymodel.h cartescene.h carteelements.h cartewidget.h mainwindow.ui cartewidget.ui icones.qrc data/xml/map_montreal.osm data/xml/*.xml data/images/icons/*.png data/images/stations/*.jpg data/images/stations/*.gif data/images/vehicules/*.png projet.pro
...
compiler_uic_make_all: ui_mainwindow.h ui_cartewidget.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_cartewidget.h
