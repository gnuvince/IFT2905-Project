...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Wed Apr 27 15:09:24 2011
# Project:  projet.pro
# Template: app
# Command: /opt/qtsdk-2010.05/qt/bin/qmake -o Makefile projet.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DPATH="\"/u/thiviere/Documents/IFT2905/IFT2905-Project\"" -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED
...
tar:
	tar -zcf projet.tar.gz geoposition.cpp geopositiondelegate.cpp main.cpp mainwindow.cpp manote.cpp note.cpp notemodel.cpp reservation.cpp reservationmodel.cpp simulateur.cpp station.cpp stationmodel.cpp usager.cpp usagermodel.cpp vehicule.cpp vehiculemodel.cpp reservationproxymodel.cpp robot.cpp cartescene.cpp carteelements.cpp cartewidget.cpp userinterface.cpp pages/page.cpp pages/mainmenupage.cpp pages/findstationpage.cpp pages/selectpositionpage.cpp pages/selectstationpage.cpp pages/selecttimepage.cpp pages/selectcarpage.cpp pages/confirmpage.cpp stationsortproxy.cpp pages/commentspage.cpp pages/unexpectedpage.cpp pages/bookingspage.cpp pages/mymessagespage.cpp pages/writecommentpage.cpp pages/infostationpage.cpp vehiculefilterproxy.cpp reservationfilterproxy.cpp geoposition.h geopositiondelegate.h mainwindow.h manote.h note.h notemodel.h reservation.h reservationmodel.h simulateur.h station.h stationmodel.h usager.h usagermodel.h vehicule.h vehiculemodel.h robot.h reservationproxymodel.h cartescene.h carteelements.h cartewidget.h userinterface.h pages/page.h pages/mainmenupage.h pages/findstationpage.h pages/selectpositionpage.h pages/selectstationpage.h pages/selecttimepage.h pages/selectcarpage.h pages/confirmpage.h stationsortproxy.h pages/commentspage.h pages/unexpectedpage.h pages/myrsvppage.h pages/bookingspage.h pages/mymessagespage.h pages/writecommentpage.h pages/infostationpage.h vehiculefilterproxy.h reservationfilterproxy.h mainwindow.ui cartewidget.ui userinterface.ui icones.qrc data/xml/map_montreal.osm data/xml/*.xml data/images/icons/*.png data/images/stations/*.jpg data/images/stations/*.gif data/images/vehicules/*.png projet.pro
...
moc_page.cpp: pages/page.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/page.h -o moc_page.cpp

moc_mainmenupage.cpp: pages/page.h \
		pages/mainmenupage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/mainmenupage.h -o moc_mainmenupage.cpp

moc_findstationpage.cpp: pages/page.h \
		pages/findstationpage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/findstationpage.h -o moc_findstationpage.cpp

moc_selectpositionpage.cpp: pages/page.h \
		geoposition.h \
		cartewidget.h \
		pages/selectpositionpage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/selectpositionpage.h -o moc_selectpositionpage.cpp
...
moc_selectstationpage.cpp: stationsortproxy.h \
	...
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/selectstationpage.h -o moc_selectstationpage.cpp

moc_selecttimepage.cpp: pages/page.h \
		pages/selecttimepage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/selecttimepage.h -o moc_selecttimepage.cpp
...
moc_selectcarpage.cpp: pages/page.h \
	...
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/selectcarpage.h -o moc_selectcarpage.cpp
...
moc_confirmpage.cpp: pages/page.h \
		...
		stationmodel.h \
		pages/confirmpage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/confirmpage.h -o moc_confirmpage.cpp

moc_stationsortproxy.cpp: stationsortproxy.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) stationsortproxy.h -o moc_stationsortproxy.cpp

moc_commentspage.cpp: pages/page.h \
		pages/commentspage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/commentspage.h -o moc_commentspage.cpp

moc_unexpectedpage.cpp: pages/page.h \
		pages/unexpectedpage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/unexpectedpage.h -o moc_unexpectedpage.cpp
...
moc_bookingspage.cpp: pages/page.h \
	...
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/bookingspage.h -o moc_bookingspage.cpp

moc_mymessagespage.cpp: pages/page.h \
		pages/mymessagespage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/mymessagespage.h -o moc_mymessagespage.cpp

moc_writecommentpage.cpp: pages/page.h \
		pages/writecommentpage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/writecommentpage.h -o moc_writecommentpage.cpp

moc_infostationpage.cpp: pages/page.h \
		station.h \
		geoposition.h \
		pages/infostationpage.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) pages/infostationpage.h -o moc_infostationpage.cpp
...
moc_vehiculefilterproxy.cpp: reservation.h \
		...
		vehicule.h \
		vehiculefilterproxy.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) vehiculefilterproxy.h -o moc_vehiculefilterproxy.cpp
...
moc_reservationfilterproxy.cpp: reservationmodel.h \
		...
		usager.h \
		reservationfilterproxy.h
	/opt/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) reservationfilterproxy.h -o moc_reservationfilterproxy.cpp
